...
class Signinfo extends Backend
{
     ...
     * @return void
     */
    public function add($league_signin_id='',$channel = 'Manual',$address='')
    {
    ...
    public function share($league_signin_id = ''){//http://localhost/SMeicOKotq.php/league/signinfo/signin/league_signin_id/5
        $this->view->assign("url", url('league/signinfo/signin/league_signin_id/5'));
        return $this->view->fetch();
    }
    public function signin($league_signin_id = '')
    {
        if($this->request->isPost()){
            $channel = 'WeChat';
            $address = '';
            $this->add($league_signin_id,$channel,$address);
        }
